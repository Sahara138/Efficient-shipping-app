...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  // Create URL object from the current request
...
function ProductRow({
  ...
  return (
    <div
      style={{
        display: "grid",
        gridTemplateColumns: "minmax(280px, 2fr) 1fr 1fr 120px 130px",
        gap: "20px",
        padding: "18px 24px",
    ...
    <Button
      ...
      url={
        pageInfo.hasPreviousPage
          ? `/app/products?direction=previous&before=${pageInfo.startCursor}&query=${encodeURIComponent(searchQuery)}`
          : undefined
      }
    >
      Previous
    ...
    <Button
      ...
      url={
        pageInfo.hasNextPage
          ? `/app/products?direction=next&after=${pageInfo.endCursor}&query=${encodeURIComponent(searchQuery)}`
          : undefined
      }
    >
      Next
